...
export default defineConfig({
  ...
  shortcuts: [{
    ...
    'gen-slate-btn': 'h-12 px-4 py-2 bg-(slate op-20) hover:bg-op-25 rounded-sm',
    ...
    'gen-textarea': 'w-full px-3 py-3 min-h-12 max-h-36 rounded-sm bg-(slate op-20) resize-none base-focus placeholder:op-50 dark:(placeholder:op-30) scroll-pa-8px',
